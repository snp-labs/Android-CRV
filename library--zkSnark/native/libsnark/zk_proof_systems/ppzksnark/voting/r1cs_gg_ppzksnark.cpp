...
bool r1cs_gg_ppzksnark_proving_key<ppT>::operator==(const libsnark::r1cs_gg_ppzksnark_proving_key<ppT> &other) const
{
...
template<typename ppT>
std::ostream& operator<<(std::ostream &out, const libsnark::r1cs_gg_ppzksnark_proving_key<ppT> &pk)
{
...
template<typename ppT>
std::istream& operator>>(std::istream &in, libsnark::r1cs_gg_ppzksnark_proving_key<ppT> &pk)
{
    in >> pk.alpha_g1;
